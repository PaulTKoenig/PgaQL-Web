...
<div class="nav-bar fixed w-full flex h-14 z-10">
    ...
    <div class="flex my-auto ml-auto mr-5 gap-1">
        <div tabindex="0" onblur={closeNav}>
            ...
            <div class="nav-dropdown" class:show-nav-dropdown={showNav}>
                ...
                <div class="small-screen-nav-logos">
                    <a class="small-screen-social-media-nav-logo" href="https://www.linkedin.com/in/paul-koenig-" target="_blank">
                    ...
                    <a class="small-screen-social-media-nav-logo" href="https://github.com/PaulTKoenig" target="_blank">
        ...
        <div class="large-screen-nav-logos">
            <a class="social-media-nav-logo" href="https://www.linkedin.com/in/paul-koenig-" target="_blank">
            ...
            <a class="social-media-nav-logo" href="https://github.com/PaulTKoenig" target="_blank">
